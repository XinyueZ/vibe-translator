...
class TranslatorUI:
    ...
    def _update_backend_label(self):
        ...
        if use_local:
            ...
            lbl = tk.Label(self.backend_frame, text="ollama", font=("Arial", 15, "bold"), bg=self.colors['bg'], fg=self.colors['button_bg'])
            lbl.pack(side=tk.LEFT, padx=(0, 5))
            
            self.ollama_model_var = tk.StringVar(value=current_model)
            model_btn = tk.Label(self.backend_frame, textvariable=self.ollama_model_var, font=("Arial", 15), bg=self.colors['textbox_bg'], fg=self.colors['fg'], relief=tk.SOLID, borderwidth=1, padx=8, pady=2, cursor='hand2')
            model_btn.pack(side=tk.LEFT)
            
            model_arrow = tk.Label(self.backend_frame, text=" ▼", font=("Arial", 12), bg=self.colors['bg'], fg=self.colors['label_fg'])
            ...
            lbl = tk.Label(self.backend_frame, text=backend, font=("Arial", 15, "bold"), bg=self.colors['bg'], fg=self.colors['button_bg'])
    ...
    def _build_main_ui(self):
        ...
        self.title_label = tk.Label(title_frame, text=self.t['wait'], font=("Arial", 20, "bold"), bg=self.colors['bg'], fg=self.colors['label_fg'])
        ...
        style_label = tk.Label(title_frame, text=self.t['style'], font=("Arial", 15), bg=self.colors['bg'], fg=self.colors['label_fg'])
        style_label.pack(side=tk.LEFT, padx=(20, 5))

        self.style_button = tk.Label(title_frame, textvariable=self.style_var, font=("Arial", 15), bg=self.colors['textbox_bg'], fg=self.colors['fg'], relief=tk.SOLID, borderwidth=1, padx=8, pady=4, cursor='hand2')
        self.style_button.pack(side=tk.LEFT)

        style_arrow = tk.Label(title_frame, text=" ▼", font=("Arial", 12), bg=self.colors['bg'], fg=self.colors['label_fg'])
        style_arrow.pack(side=tk.LEFT)
        ...
        font_size_label = tk.Label(title_frame, text=self.t['font'], font=("Arial", 15), bg=self.colors['bg'], fg=self.colors['label_fg'])
        font_size_label.pack(side=tk.LEFT, padx=(20, 5))

        self.font_size_button = tk.Label(title_frame, text=str(self.font_size_var.get()), font=("Arial", 15), bg=self.colors['textbox_bg'], fg=self.colors['fg'], relief=tk.SOLID, borderwidth=1, padx=8, pady=4, cursor='hand2')
        self.font_size_button.pack(side=tk.LEFT)

        font_size_arrow = tk.Label(title_frame, text=" ▼", font=("Arial", 12), bg=self.colors['bg'], fg=self.colors['label_fg'])
        font_size_arrow.pack(side=tk.LEFT)
        
        self.refresh_button = tk.Label(title_frame, text="🔄", font=("Arial", 22), bg=self.colors['bg'], fg=self.colors['fg'], cursor='hand2')
        ...
        self.stop_button = tk.Label(title_frame, text="🛑", font=("Arial", 22), bg=self.colors['bg'], fg=self.colors['fg'], cursor='hand2')
